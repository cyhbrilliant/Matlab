...
%
%   [1] Ukwatta, E.; Yuan, J.; Rajchl, M.; Qiu, W.; Tessier, D; Fenster, A.
%       3D Carotid Multi-Region MRI Segmentation by Globally Optimal 
%       Evolution of Coupled Surfaces
%       IEEE Transactions on Medical Imaging, 2013
%
%   [2] Rajchl, M.; Baxter, JSH.; Bae, E.; Tai, X-C.; Fenster, A.; 
%       Peters, TM.; Yuan, J.;
...
maxLevelSetIterations = 150; % number of maximum time steps
tau = 5; % speed parameter
...
for t=1:maxLevelSetIterations
    ...
    for i=1:numberOfLabels
        ...
        % 7. Compute a speed data term based on the sub-region extent as [2]:
